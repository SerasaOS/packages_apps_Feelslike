...
public class MiscSettings extends SettingsPreferenceFragment implements
    ...
    private static final String PREF_ADBLOCK = "persist.serasa.hosts_block";
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.serasa_settings_misc);
        ...
        if (!SerasaUtils.deviceHasFlashlight(mContext)) {
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.serasa_settings_misc) {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    if (!SerasaUtils.deviceHasFlashlight(context)) {
