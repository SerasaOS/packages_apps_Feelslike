...
import com.serasa.settings.utils.WallpaperUtils;
...
public class MonetSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mColorPickerView = new ColorPickerView.Builder(getContext()).setActionMode(ActionMode.LAST).setPaletteDrawable(WallpaperUtils.getWall(getContext(), false)).setPreferenceName("SerasaColorPicker").setColorListener(new ColorListener() {
