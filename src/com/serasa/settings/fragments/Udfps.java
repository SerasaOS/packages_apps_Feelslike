...
import com.serasa.settings.fragments.UdfpsIconPicker;
...
public class Udfps extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.serasa_settings_udfps);

        final PreferenceScreen prefSet = getPreferenceScreen();
        Resources resources = getResources();

        final boolean udfpsResPkgInstalled = SerasaUtils.isPackageInstalled(getContext(),
                "com.serasa.udfps.icons");
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.serasa_settings_udfps);
}
