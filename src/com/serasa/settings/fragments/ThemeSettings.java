...
import com.serasa.settings.preferences.SecureSettingListPreference;
import com.serasa.settings.preferences.SystemSettingSwitchPreference;
import com.serasa.settings.preferences.SystemSettingEditTextPreference;
...
public class ThemeSettings extends DashboardFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        boolean turboInstalled = SerasaUtils.isPackageInstalled(getContext(),
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mShowBrightnessSlider) {
            ...
            SerasaUtils.showSettingsRestartDialog(getContext());
            return true;
            ...
            SerasaUtils.showSystemUiRestartDialog(getContext());
            return true;
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.serasa_settings_themes;
    }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.serasa_settings_themes) {

                @Override
                public List<String> getNonIndexableKeys(Context context) {
                    List<String> keys = super.getNonIndexableKeys(context);
                    final Resources res = context.getResources();
                    boolean turboInstalled = SerasaUtils.isPackageInstalled(context,
                            "com.google.android.apps.turbo");
